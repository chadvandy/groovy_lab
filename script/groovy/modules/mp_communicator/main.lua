...
--- Usage:
--[[
    local communicator = MultiplayerCommunicator

    -- listen for an event!
    communicator:RegisterForEvent("my_event_name", "my_event_listener_name", function(payload)
        -- do stuff with payload
    end)

    -- trigger an event!
    communicator:TriggerEvent("my_event_name", cm:get_local_faction(true):command_queue_index(), 
        {
            my = "payload",
            goes = "here"
        }
    ...
    -- trigger an event for the current played faction!
    communicator:TriggerEventFromLocalFaction("my_event_name", 
        {
            my = "payload",
            goes = "here"
        }
...
---@param event_name string
---@param table table
function MultiplayerCommunicator:TriggerEventFromLocalFaction(event_name, table)
