...
---@param self T
---@return T
function default_class:__new()
	return new_obj(self)
end

function default_class:subclasses(filter, ...)
...
function default_class:instances(filter, ...)
...
function default_class:subclassOf(superclass)
...
_class = function(className, attr)
	...
	c.__new = default_class.__new
	
	c.instances = default_class.instances
	
	c.subclasses = default_class.subclasses
	c.subclassOf = default_class.subclassOf
	
	c.classOf = default_class.classOf

	c.instanceOf = default_class.instanceOf
